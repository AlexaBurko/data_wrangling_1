...
To use select, the first thing in the brackets in the data frame, and
the next things are rhe variables you want to keep

Using : means to select all the variables between the two listed
variables

Using - before the variable name means to keep all variables except for
that one
...
```
    ...
    ##       litter_number sex pd_ears pd_eyes pd_pivot pd_walk new_pd
    ## 1               #85   1       4      13        7      11      4
    ## 2               #85   1       4      13        7      12      5
